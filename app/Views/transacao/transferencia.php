...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="w3-container">
        <h3 id="titulo">Nova Transferência</h3>
        <form action="/transacao/transferencia" method="post">
            <table style="width: 100%;">
                <tbody>
                    <tr>
                        <td><label for="data">Data: </label></td>
                        <td><label for="valor">Valor (R$): </label></td>
                        <td><label for="valor">Conta destino: </label></td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input required type="text" name="contadestino" class="w3-white w3-border w3-round-large">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">
